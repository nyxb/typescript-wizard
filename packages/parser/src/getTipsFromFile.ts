...
import type { Tip, TipType } from './tips'
...
export function getTipsFromFile(fileContents: string,
   tipToFilter?: TipType) {
...
function tipFunctionsToTraverseOptions(tipFunctions: TipFunctions): TraverseOptions {
